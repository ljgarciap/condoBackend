...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Admin Person
        $adminPerson = \App\Models\Person::create([
            'name' => 'Administrador',
            'document' => '12345678',
            'document_type' => 'CC',
        ...
        // Vigilante Person
        $vigilantePerson = \App\Models\Person::create([
            'name' => 'Vigilante',
            'document' => '87654321',
            'document_type' => 'CC',
        ...
        $apt = \App\Models\Apartment::create(['number' => '101', 'block' => 'A', 'owner_id' => null]);
        
        $residentPerson = \App\Models\Person::create([
            'name' => 'Luis Residente',
            'document' => '10203040',
            'document_type' => 'CC',
